...
public class TestAccount {
	...
	public static void main(String[] args) {
		...
		double monthlyRate = a1.getMonthlyInterestRate();
		double monthly = a1.getMonthlyInterest(monthlyRate);
		
		System.out.println("Account Id " + a1.getId());
		System.out.println("Balance " + a1.getBalance());
		System.out.println("Monthly Interest " + monthly);
		System.out.println("Date created " + a1.getDate());
